...
namespace Lykke.Snow.Notifications.Tests
{
    public class DeviceRegistrationTests
    {
        ...
        class DeviceRegistrationTestData : IEnumerable<object[]>
        {
            ...
            {
                yield return new object[] { new DeviceRegistration("any-account-id", "any-device-token") };
            }
        ...
        class DeviceRegistrationCollectionTestData : IEnumerable<object[]>
        {
            public IEnumerator<object[]> GetEnumerator()
            {
                ...
                { 
                    ...
                    {
                        new DeviceRegistration("account-id-1", "device-token-1"), 
                        new DeviceRegistration("account-id-1", "device-token-2"), 
                        new DeviceRegistration("account-id-1", "device-token-3")
                    }
                };
            }
        ...
        public async Task RegisterDevice_ShouldSet_RegisteredOn()
        {
            ...
            await sut.RegisterDeviceAsync(new DeviceRegistration("any-account-id", "any-device-token"));
